...
my $hmd_unit=25; my $win_leng=5000; my $measure=50;
my $win_size=5000;  my $dis1=30000;my $dis2=40000;
my @name=("A4","A7");
my @combine=('1_2','1_2_3');
my $strain="A4"; my $alter="A6";#need to match the index below
...
my $p= $index_pair[$rep];
my $outfile1="/dfs7/grylee/yuhenh3/HC_HiFi/focal_".$name[$index]."_HiFi_".$p."_height_HMD_25_".$win_leng."_".$measure."_measures_mean.txt"; 
...
my $infile2="/dfs7/grylee/hgshukla/HiC_Project/A4/sample1/UU_minmapq_0/code_process_UU_MU_parallel/LNorm/UU_MU/A4_A7.UU_MU.Zscore.SigFlag.txt";#for A4 genome
#my $infile2="/dfs7/grylee/hgshukla/HiC_Project/A7/sample1/code_process_MU_UU_Parallel/LNorm/UU_MU/A7_A4.UU_MU.Zscore.SigFlag.txt"; #for A7 genome
